...
public class PlayerWeaponsManager : MonoBehaviour
{
    ...
    {
        m_PlayerCharacterController.playerCamera.SetCameraFOV(fov);
    ...
    void UpdateWeaponAiming()
    {
        if (m_WeaponSwitchState == WeaponSwitchState.Up)
        {
            ...
            if (isAiming && activeWeapon)
            {
                ...
                SetFOV(Mathf.Lerp(m_PlayerCharacterController.playerCamera.GetFOV, activeWeapon.aimZoomRatio * defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
            else
            {
                ...
                SetFOV(Mathf.Lerp(m_PlayerCharacterController.playerCamera.GetFOV, defaultFOV, aimingAnimationSpeed * Time.deltaTime));
            }
        }
    }
